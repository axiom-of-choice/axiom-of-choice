...
| [mlx-community](https://huggingface.co/mlx-community/GLM-4.1V-9B-Thinking-8bit) | Quantization | MLX quantizations for Apple Silicon, including an 8-bit GLM-4.1V-9B-Thinking that preserves the vision path, and 4/6/8-bit variants of a 4.5B agentic VLM evaluated against the bf16 source on perplexity, KL divergence, task accuracy and blind pairwise LLM-judge quality |
